...
//!
//! @version $Revision: 1.0 $Name: C. Muri
//!
//! @todo
//! @bug
//******************************************************************************
...
//  @fn get_idmask
//!
//! Diese Funktion gibt die CAN Maske für die Maskierte RX Befehle
//!
//! @warning id_mask muss initialisert sein (st_cmd_t -> id_mask fon cmd)
//!
//! @param  st_com_t für Maske und entscheit ob 11 oder 29 Bit Maske
//!
//! @return ID Mask
//!          11 Bit ID Maske für CAN Treiber oder
//!			 29 Bit ID Maske für CAN Treiber
//!
...
//  @fn can_off
//!
//! CAN macro BUS_Off. Switch off the CAN Bus. Start CAN Bus with can_init()
//!
//! @warning non
//!
//! @param  non
...
void can_off (void)								//Änderung Muri Christian
{
