...
#   elif CAN_BAUDRATE == 1000      //!< -- 1 Mb/s, 16x Tscl, sampling at 69%
#       define CONF_CANBT1  0x00       // Tscl  = 2x Tclkio = 125 ns
...
//CAN_Autobaud removed by PHIL: #if     CAN_BAUDRATE == CAN_AUTOBAUD
...
//!          - 0xFF if no MOb
//!
extern  U8 can_get_mob_free(void); //Anderueng
...
//!
extern U8 can_fixed_baudrate(U8 baudrate);


//------------------------------------------------------------------------------
//  @fn Can_conf_bt_flex
//!
extern U8 Can_conf_bt_flex(U8 BT1, U8 BT2, U8 BT3);
